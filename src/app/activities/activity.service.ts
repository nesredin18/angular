...
export class ActivityService {
  ...
  CreateActivity(Objective_ID:number,Ob_Name: string, Ob_Description: string, Initial_date: string, Final_date: string, Status: string, Goal: string, Result: string) {
    const data = {
  ...
  UpdateActivity(id: number, Ob_Name: string, Ob_Description: string, Initial_date: Date, Final_date: Date, Status: string, Goal: string, Result: string) {
    const data = {
      Name: Ob_Name,
      Description: Ob_Description,
      Initial_date: Initial_date,
